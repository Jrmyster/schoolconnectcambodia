...
type NavGroupColor = "slate" | "orange" | "violet" | "blue" | "cyan" | "lime" | "emerald" | "indigo";
...
const COLOR_THEMES: Record<NavGroupColor, { default: string; active: string }> = {
  ...
  indigo:  { default: "bg-indigo-500/10 text-indigo-700 hover:bg-indigo-600 hover:text-white",    active: "bg-indigo-600 text-white shadow-md shadow-indigo-700/25" },
};
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/science/frugal-blueprint",
        labelEn: "The Frugal Blueprint",
        labelKh: "គម្រោងវិស្វកម្មសន្សំសំចៃ",
        icon: Hammer,
        descEn: "Solve hands-on engineering challenges! Buy upcycled materials within a budget, lock in designs, and test filters, coolers, or solar cookers.",
        descKh: "ដោះស្រាយបញ្ហាប្រឈមវិស្វកម្មផ្ទាល់! ទិញសម្ភារៈកែច្នៃឡើងវិញក្នុងកម្រិតថវិកា កំណត់ការរចនា និងធ្វើតេស្តប្រព័ន្ធចម្រោះទឹក ប្រព័ន្ធត្រជាក់ ឬចង្ក្រានសូឡា។",
      },
      {
        href: "/science/pixel-map-reveal",
        labelEn: "Pixel Map Reveal",
        labelKh: "ល្បែងស្វែងរកទីតាំងសម្ងាត់",
        icon: Map,
        descEn: "Guess the landmark, province, or historical event! A projector-friendly game that slowly reveals blurred or zoomed-in images in 10 stages.",
        descKh: "ទាយតំបន់ប្រវត្តិសាស្ត្រ ទីតាំងល្បីៗ ឬខេត្តក្រុង! ល្បែងបង្ហាញរូបភាពព្រាលៗ ឬពង្រីកធំជា ១០ វគ្គ ងាយស្រួលមើលលើអេក្រង់ធំ។",
      },
      {
        href: "/science/historical-timeline-sorter",
        labelEn: "Historical Timeline Sorter",
        labelKh: "ល្បែងតម្រៀបកាលប្បវត្តិប្រវត្តិសាស្ត្រ",
        icon: Hourglass,
        descEn: "Arrange historical events in correct chronological order! A projector-friendly game with swap controls and sliding animations, tiered by grade level.",
        descKh: "តម្រៀបព្រឹត្តិការណ៍ប្រវត្តិសាស្ត្រតាមលំដាប់កាលប្បវត្តិត្រឹមត្រូវ! ល្បែងកម្សាន្តងាយស្រួលមើលលើអេក្រង់ធំ ជាមួយការចុចប្តូរទីតាំង ទៅតាមកម្រិតថ្នាក់។",
      },
      {
      ...
      },
      {
        ...
        labelEn: "Gabriel Synthesis",
        labelKh: "សំយោគ Gabriel (អាមីន)",
        icon: Hexagon,
        descEn: "Explore the step-by-step SN2 reaction mechanism to prepare pure primary amines.",
        descKh: "សិក្សាជំហានលម្អិតនៃយន្តការប្រតិកម្ម SN2 ដើម្បីសំយោគអាមីនលំដាប់ទី១ ឲ្យបរិសុទ្ធ។",
      },
      {
        href: "/chemistry/grignard-reaction",
        labelEn: "Grignard Reaction: Carbon Chains",
        labelKh: "ប្រតិកម្ម Grignard៖ ខ្សែស្រឡាយកាបូន",
        icon: FlaskRound,
        descEn: "Observe the nucleophilic addition of Grignard reagents to build complex carbon-carbon bonds.",
        descKh: "សិក្សាប្រតិកម្មបូកញុយក្លេអូភីលនៃ Grignard ដើម្បីបង្កើតសម្ព័ន្ធកាបូន-កាបូនស្មុគស្មាញ។",
      },
      {
        href: "/chemistry/titration",
        labelEn: "Titrations (Volumetric Analysis)",
        labelKh: "ទីត្រាស់ (ការវិភាគមាឌ)",
        icon: FlaskConical,
        descEn: "Simulate acid-base titrations, measure standard solutions, and observe the endpoint color change.",
        descKh: "ពិសោធន៍ទីត្រាស់អាស៊ីត-បាស វាស់មាឌសូលុយស្យុងស្តង់ដារ និងសង្កេតការប្រែពណ៌ចំណុចសមមូល។",
      },
      {
        href: "/chemistry/mole-stoichiometry",
        labelEn: "The Mole Concept & Stoichiometry",
        labelKh: "គំនិតម៉ូល និងស្តូគីយូម៉ែត្រ",
        icon: Atom,
        descEn: "Explore stoichiometry conversions between mass, moles, particles, and volume of gases at STP.",
        descKh: "សិក្សាបំលែងស្តូគីយូម៉ែត្ររវាងម៉ាស់ ម៉ូល ភាគល្អិត និងមាឌឧស្ម័ននៅលក្ខខណ្ឌ STP។",
      },
      {
        href: "/chemistry/quantum-mechanics",
        labelEn: "Atomic Structure & Quantum Mechanics",
        labelKh: "រចនាសម្ព័ន្ធអាតូម និងមេកានិចកង់ទិច",
        icon: Atom,
        descEn: "Simulate Bohr orbits, calculate electron energy levels, and explore quantum mechanical relations.",
        descKh: "ពិសោធន៍គន្លង Bohr គណនាកម្រិតថាមពលអេឡិចត្រុង និងសិក្សាទំនាក់ទំនងមេកានិចកង់ទិច។",
      },
      {
        href: "/chemistry/lewis-structures",
        labelEn: "Lewis Structures & Valence Electrons",
        labelKh: "ទម្រង់លុយអុីស និងអេឡិចត្រុងវ៉ាឡង់",
        icon: Sparkles,
        descEn: "Draw electron-dot structures, identify valence shells, and learn octet rules step-by-step.",
        descKh: "គូរទម្រង់អេឡិចត្រុងចំនុច ស្វែងយល់ពីស្រទាប់វ៉ាឡង់ និងរៀនវិធានអដ្ឋធាតុមួយជំហានម្តងៗ។",
      },
      {
        href: "/chemistry/vsepr",
        labelEn: "VSEPR Theory & Shape",
        labelKh: "ទ្រឹស្តី VSEPR និងទម្រង់ម៉ូលេគុល",
        icon: Hexagon,
        descEn: "Explore how electron pair repulsions shape CH4, NH3, and H2O molecules in 3D.",
        descKh: "ស្វែងយល់ពីរបៀបដែលកម្លាំងច្រានគ្នានៃអេឡិចត្រុងបង្កើតទម្រង់ម៉ូលេគុល CH4, NH3 និង H2O ក្នុងទម្រង់ ៣ វិមាត្រ។",
      },
      {
        href: "/chemistry/element-timeline",
        labelEn: "Timeline of Element Discoveries",
        labelKh: "កាលប្បវត្តិនៃការរកឃើញធាតុគីមី",
        icon: Compass,
        descEn: "Discover when and where humanity first identified and smelted the 10 ancient elements.",
        descKh: "ស្វែងយល់ពីពេលវេលានិងទីកន្លែងដែលមនុស្សជាតិបានរកឃើញ និងរំលាយធាតុគីមីបុរាណទាំង ១០ ដំបូង។",
      },
      {
        href: "/chemistry/gas-laws",
        labelEn: "Gas Laws & Thermodynamics",
        labelKh: "ច្បាប់ឧស្ម័ន និងទែម៉ូឌីណាមិច",
        icon: Wind,
        descEn: "Simulate pressure, volume, and temperature relationships and explore gas constants in 2D.",
        descKh: "ពិសោធន៍ទំនាក់ទំនងរវាងសម្ពាធ មាឌ និងសីតុណ្ហភាព និងសិក្សាលំអិតពីថេរឧស្ម័នជា ២ វិមាត្រ។",
      },
      {
        href: "/chemistry/solubility",
        labelEn: "Factors Affecting Solubility",
        labelKh: "កត្តាជះឥទ្ធិពលលើភាពរលាយ",
        icon: Droplet,
        descEn: "Simulate solid and gas solubility under changing temperature and pressure.",
        descKh: "ពិសោធន៍ភាពរលាយនៃសារធាតុរឹង និងឧស្ម័ន ក្រោមការប្រែប្រួលសីតុណ្ហភាព និងសម្ពាធ។",
      },
      {
      ...
      {
        href: "/science/time-travel",
        labelEn: "Time Travel in Movies: The Physics of Fiction",
        labelKh: "ការធ្វើដំណើរឆ្លងពេលវេលាក្នុងភាពយន្ត៖ រូបវិទ្យានៃរឿងប្រឌិត",
        icon: Hourglass,
        descEn: "Explore the rules of cinematic time travel: information, consciousness, and physical travel under Novikov vs Multiverse timelines.",
      ...
      {
        href: "/mathematics/target-number",
        labelEn: "The Target Number",
        labelKh: "ល្បែងស្វែងរកលេខគោលដៅ",
        icon: Calculator,
        descEn: "A massive, projector-friendly math game! Use the 6 base numbers to get as close as possible to the target number under a 2-minute timer.",
        descKh: "ល្បែងគណិតវិទ្យាដ៏ធំដែលងាយស្រួលមើលតាមម៉ាស៊ីនបញ្ចាំង! ប្រើលេខមូលដ្ឋានទាំង ៦ ដើម្បីផ្គុំឱ្យបានជិតបំផុតទៅនឹងលេខគោលដៅក្រោមរយៈពេល ២ នាទី។",
      },
      {
        href: "/mathematics/grid-battleship",
        labelEn: "Grid Battleship: Math Edition",
        labelKh: "ល្បែងចម្បាំងលើក្រឡា៖ វគ្គគណិតវិទ្យា",
        icon: Ship,
        descEn: "Uncover hidden ships on a 5x5 grid by solving math equations! Tiered for 5th, 8th, and 12th grades with LaTeX rendering and projector support.",
        descKh: "ស្វែងរកនាវាចម្បាំងដែលលាក់នៅលើក្រឡា ៥x៥ ដោយដោះស្រាយសមីការគណិតវិទ្យា! បែងចែកសម្រាប់ថ្នាក់ទី៥ ទី៨ និងទី១២ ជាមួយរូបមន្ត LaTeX និងការបង្ហាញលើម៉ាស៊ីនបញ្ចាំង។",
      },
      {
      ...
      {
        href: "divider:calculus",
        labelEn: "Calculus",
        labelKh: "គណិតវិទ្យាវិភាគ (Calculus)",
        icon: Sigma,
        divider: true,
      },
      {
        href: "/mathematics/integration-techniques",
        labelEn: "Integration Techniques: U-Sub & Anti-derivatives",
        labelKh: "វិធីសាស្ត្រអាំងតេក្រាល៖ ជំនួស u និងព្រីមីទីវ",
        icon: Sigma,
        descEn: "Master integration: learn basic anti-derivatives and visual step-by-step u-substitution.",
        descKh: "ស្ទាត់ជំនាញអាំងតេក្រាល៖ សិក្សាព្រីមីទីវគ្រឹះ និងវិធីជំនួស u មួយជំហានម្តងៗជាជំនួយភ្នែក។",
      },
      {
      ...
      {
        href: "/science/star-evolution",
        labelEn: "Types of Stars & Stellar Evolution",
        labelKh: "ប្រភេទតារា និងការវិវត្តនៃផ្កាយ",
        icon: Sparkles,
        descEn: "Observe dynamic animations of 9 different star types and trace their key traits.",
        descKh: "ទស្សនាចលនាអន្តរកម្មនៃផ្កាយទាំង ៩ ប្រភេទ និងសិក្សាពីការវិវត្តរបស់វា។",
      },
      {
  ...
  },
  {
    ...
    items: [
      { href: "/sanctuary",          labelEn: "Sanctuary",             labelKh: "សន្តិភាព",                 icon: Leaf },
      {
        ...
        labelEn: "Feminine Health & Menstrual Hygiene",
        labelKh: "សុខភាពនារី និងអនាម័យមករដូវ",
        icon: HeartPulse,
        descEn: "Learn about reusable cloth pads, sustainable design, and menstrual hygiene basics with our interactive layer builder.",
        descKh: "ស្វែងយល់អំពីសំឡីអនាម័យក្រណាត់ដែលអាចប្រើឡើងវិញបាន ការរចនាប្រកបដោយនិរន្តរភាព និងមូលដ្ឋានគ្រឹះអនាម័យមករដូវ។",
      },
      {
    ...
    items: [
      {
        ...
        labelKh: "ល្បែងផ្គុំពាក្យភាសាអង់គ្លេស",
        icon: Gamepad2,
        descEn: "Break a scrambled English word into letters and piece them back together in the correct order to win! Projector friendly and perfect for classes.",
        descKh: "បំបែកពាក្យអង់គ្លេសដែលច្របូកច្របល់ទៅជាអក្សរ រួចផ្គុំវាឡើងវិញតាមលំដាប់លំដោយត្រឹមត្រូវដើម្បីឈ្នះ! ងាយស្រួលមើលតាមម៉ាស៊ីនបញ្ចាំង និងល្អបំផុតសម្រាប់ថ្នាក់រៀន។",
      },
      {
        href: "/english/vocabulary-mastermind",
        labelEn: "Vocabulary Mastermind",
        labelKh: "ល្បែងបំបែកពាក្យ",
        icon: BrainCircuit,
        descEn: "A massive, projector-friendly word guessing game to test your vocabulary. Filter by grade level, guess words in 6 attempts, and use clues to help your class solve it!",
        descKh: "ល្បែងទាយពាក្យអង់គ្លេសដ៏ធំដែលងាយស្រួលមើលតាមម៉ាស៊ីនបញ្ចាំង។ ជ្រើសរើសកម្រិតថ្នាក់ ទាយពាក្យក្នុងរយៈពេល ៦ ដង និងប្រើប្រាស់តម្រុយដើម្បីដោះស្រាយ!",
      },
      {
        href: "/english/collaborative-mad-libs",
        labelEn: "Collaborative Mad Libs",
        labelKh: "ល្បែងបំពេញពាក្យរួមគ្នា",
        icon: ScrollText,
        descEn: "Create hilarious stories with your class! Collect parts of speech in Phase 1, then reveal the bilingual story with your words injected in Phase 2.",
        descKh: "បង្កើតរឿងរ៉ាវដ៏រីករាយជាមួយសិស្សក្នុងថ្នាក់! ប្រមូលប្រភេទពាក្យក្នុងវគ្គទី ១ រួចបង្ហាញរឿងពីរភាសាជាមួយនឹងពាក្យដែលបានបញ្ចូលក្នុងវគ្គទី ២។",
      },
      {
        href: "/english/sentence-scramble-relay",
        labelEn: "Sentence Scramble Relay",
        labelKh: "ល្បែងតម្រៀបប្រយោគ",
        icon: ScrollText,
        descEn: "Unscramble English sentences as a team! Practice grammar and structure with custom grade-level difficulties and bilingual hints.",
        descKh: "តម្រៀបប្រយោគភាសាអង់គ្លេសជាក្រុម! ហាត់រៀនវេយ្យាករណ៍ និងលំដាប់ពាក្យតាមកម្រិតថ្នាក់ផ្សេងៗ ព្រមទាំងមានតម្រុយជាពីរភាសា។",
      },
      {
        href: "/study-center/spelling-bee",
        labelEn: "Spelling Bee Competition",
        labelKh: "ការប្រកួតប្រជែង Spelling Bee",
        icon: Star,
        descEn: "A projector-friendly spelling competition with audio pronunciation and hints.",
        descKh: "ការប្រកួតប្រជែងប្រកបពាក្យអន្តរកម្មដែលងាយមើលនៅលើម៉ាស៊ីនបញ្ចាំងស្លាយ ព្រមទាំងមានការអានសំឡេង។",
      },
      {
        href: "/spelling-forge",
      ...
      },
      {
        ...
        labelEn: "English Writing",
        labelKh: "ការសរសេរភាសាអង់គ្លេស",
        icon: PenLine,
      },
      {
