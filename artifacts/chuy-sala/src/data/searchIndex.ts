...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  // ── HUMAN BODY ───────────────────────────────────────────
  {
    ...
    titleKh: "ប្រព័ន្ធឆ្អឹង",
    categoryEn: "Human Body", categoryKh: "រាងកាយមនុស្ស",
    descEn: "Explore the 206 bones that give your body structure, protect organs, and make blood.",
    descKh: "រុករកឆ្អឹងទាំង ២០៦ ដែលផ្ដល់រចនាសម្ព័ន្ធ ការពារសរីរាង្គ និងបង្កើតឈាម។",
    keywordsEn: ["bones", "skeleton", "206", "skull", "femur", "calcium", "marrow", "human body", "anatomy", "joints"],
    keywordsKh: ["ឆ្អឹង", "គ្រោងឆ្អឹង", "លលាដ៍ក្បាល", "រាងកាយ", "រាងកាយមនុស្ស"],
  },
  {
    ...
    titleKh: "ប្រព័ន្ធដកដង្ហើម",
    categoryEn: "Human Body", categoryKh: "រាងកាយមនុស្ស",
    descEn: "How your lungs, diaphragm, and alveoli pull oxygen into the blood and push carbon dioxide out.",
    descKh: "របៀបដែលសួត និងសន្ទះទ្រូងរបស់អ្នកស្រូបអុកស៊ីសែនចូលទៅក្នុងឈាម និងបញ្ចេញកាបូនឌីអុកស៊ីត។",
    keywordsEn: ["lungs", "breathing", "oxygen", "alveoli", "diaphragm", "trachea", "carbon dioxide", "respiratory", "human body", "anatomy"],
    keywordsKh: ["សួត", "ដកដង្ហើម", "អុកស៊ីសែន", "រាងកាយ", "រាងកាយមនុស្ស"],
  },
  {
    id: "digestive-system",
    ...
    titleKh: "ប្រព័ន្ធរំលាយអាហារ",
    categoryEn: "Human Body", categoryKh: "រាងកាយមនុស្ស",
    descEn: "Follow food's journey from your mouth through the stomach and intestines to become energy.",
    descKh: "តាមដានដំណើរអាហារពីមាត់កាត់ក្រពះ និងពោះវៀនដើម្បីក្លាយជាថាមពល។",
    keywordsEn: ["stomach", "intestines", "food", "digestion", "digestive", "liver", "pancreas", "human body", "anatomy"],
    keywordsKh: ["ក្រពះ", "រំលាយអាហារ", "ពោះវៀន", "អាហារ", "រាងកាយ", "រាងកាយមនុស្ស"],
  },
  {
    ...
    titleKh: "ប្រព័ន្ធបន្តពូជ",
    categoryEn: "Human Body", categoryKh: "រាងកាយមនុស្ស",
    descEn: "The biological system responsible for creating life, passing on DNA, and producing essential hormones.",
    descKh: "ប្រព័ន្ធជីវសាស្ត្រដែលទទួលខុសត្រូវក្នុងការបង្កើតជីវិត បញ្ជូន DNA និងផលិតអរម៉ូនសំខាន់ៗ។",
    keywordsEn: ["reproductive", "reproduction", "ovaries", "testes", "uterus", "hormones", "dna", "human body", "anatomy", "fertilization"],
    keywordsKh: ["បន្តពូជ", "ជីវសាស្ត្រ", "អរម៉ូន", "រាងកាយ", "រាងកាយមនុស្ស", "ស្បូន"],
  },
  {
    id: "excretory-system",
    href: "/science/human-body/excretory-system",
    icon: Droplet,
    titleEn: "The Excretory System",
    titleKh: "ប្រព័ន្ធបញ្ចេញចោល",
    categoryEn: "Human Body", categoryKh: "រាងកាយមនុស្ស",
    descEn: "How your kidneys and bladder act as the body's filtration plant, removing waste and balancing fluids.",
    descKh: "របៀបដែលតម្រងនោម និងប្លោកនោមរបស់អ្នកដំណើរការជារោងចក្រចម្រោះ កម្ចាត់កាកសំណល់ និងធ្វើតុល្យភាពជាតិទឹក។",
...

  {
    ...
    titleKh: "ប្រព័ន្ធភាពស៊ាំ",
    categoryEn: "Human Body", categoryKh: "រាងកាយមនុស្ស",
    descEn: "The white blood cells, antibodies, and defenders that protect your body from viruses and bacteria.",
    descKh: "កោសិកាឈាមស អង់ទីគ័រ និងអ្នកការពារដែលការពាររាងកាយរបស់អ្នកពីមេរោគ និងបាក់តេរី។",
    keywordsEn: ["immune", "immunity", "white blood cells", "antibodies", "virus", "bacteria", "infection", "defense", "human body", "anatomy", "pathogens"],
    keywordsKh: ["ភាពស៊ាំ", "កោសិកាឈាមស", "មេរោគ", "អង់ទីគ័រ", "រាងកាយ", "រាងកាយមនុស្ស"],
  },
  {
    id: "endocrine-system",
    ...
    titleKh: "ប្រព័ន្ធអង់ដូគ្រីន",
    categoryEn: "Human Body", categoryKh: "រាងកាយមនុស្ស",
    descEn: "The chemical messengers (hormones) that control growth, sleep, mood, and energy across your body.",
    descKh: "អ្នកនាំសារគីមី (អរម៉ូន) ដែលគ្រប់គ្រងការលូតលាស់ ការគេង អារម្មណ៍ និងថាមពលទូទាំងរាងកាយ។",
    keywordsEn: ["endocrine", "hormones", "glands", "thyroid", "adrenal", "pituitary", "insulin", "human body", "anatomy", "chemical messengers"],
    keywordsKh: ["អង់ដូគ្រីន", "អរម៉ូន", "ក្រពេញ", "រាងកាយ", "រាងកាយមនុស្ស"],
  },
  ...
  },
  {
    ...
    titleKh: "ផែនទីសកល",
    categoryEn: "Study Center", categoryKh: "មជ្ឈមណ្ឌលសិក្សា",
    descEn: "Explore the world's population, continents, and countries with real-time statistics.",
    descKh: "រុករកចំនួនប្រជាជន ទ្វីប និងប្រទេសជុំវិញពិភពលោកជាមួយនឹងស្ថិតិជាក់ស្តែង។",
    keywordsEn: ["atlas", "global atlas", "world map", "countries", "continents", "population", "earth", "geography", "demographics", "world population"],
    keywordsKh: ["ផែនទីសកល", "ផែនទីពិភពលោក", "ប្រទេស", "ចំនួនប្រជាជន", "ភូមិសាស្ត្រ"],
  },
  {
    id: "global-cities",
    href: "/global-cities",
  ...
  {
    id: "well-being-disease-divide",
    href: "/well-being/disease-divide",
    icon: Globe,
    titleEn: "The Disease Divide: Global Health Perspectives",
    titleKh: "គម្លាតនៃជំងឺ៖ ទិដ្ឋភាពសុខភាពសកល",
    categoryEn: "Public Health · Global Epidemiology",
    categoryKh: "សុខភាពសាធារណៈ · រោគរាតត្បាតសកល",
    descEn:
      "The Epidemiological Transition: as a country builds clean water, sanitation, vaccines, and hospitals, the diseases that kill its citizens shift from infectious killers (cholera, diarrheal disease, malaria, tuberculosis) to chronic and lifestyle killers (heart disease, type 2 diabetes, cancer, Alzheimer's). Understand why a child's address often determines what disease they will die of.",
    descKh:
      "អន្តរកាលរោគរាតត្បាត៖ ពេលប្រទេសសាងសង់ទឹកស្អាត អនាម័យ វ៉ាក់សាំង និងមន្ទីរពេទ្យ ជំងឺដែលសម្លាប់ប្រជាជនរបស់ខ្លួនផ្លាស់ប្តូរពីអ្នកសម្លាប់ឆ្លង (អាសន្នរោគ ជំងឺរាគ គ្រុនចាញ់ របេង) ទៅជាអ្នកសម្លាប់រ៉ាំរ៉ៃ និងជំងឺនៃរបៀបរស់នៅ (បេះដូង ទឹកនោមផ្អែមប្រភេទ ២ មហារីក Alzheimer)។ យល់ហេតុអ្វីអាស័យដ្ឋានរបស់កុមារជាញឹកញាប់កំណត់ជំងឺដែលគេនឹងស្លាប់ដោយ។",
    keywordsEn: [
      "epidemiology", "epidemiological transition",
      "infectious disease", "communicable disease", "communicable",
      "chronic disease", "non-communicable disease", "ncd", "lifestyle disease",
      "water-borne", "waterborne", "water borne", "cholera", "diarrhea", "diarrheal",
      "malaria", "tuberculosis", "tb",
      "heart disease", "cardiovascular", "coronary", "stroke",
      "diabetes", "type 2 diabetes", "insulin",
      "cancer", "tumor", "alzheimer", "alzheimers", "dementia",
      "lmic", "low income", "middle income", "high income", "global health",
      "sanitation", "clean water", "vaccine", "vaccination",
      "infrastructure", "wellbeing", "well-being", "public health",
      "disease divide", "global health perspectives",
    ],
    keywordsKh: [
      "រោគរាតត្បាត", "អន្តរកាលរោគរាតត្បាត",
      "ជំងឺឆ្លង", "ជំងឺមិនឆ្លង", "ជំងឺរ៉ាំរ៉ៃ", "ជំងឺនៃរបៀបរស់នៅ",
      "ជំងឺមកពីទឹក", "អាសន្នរោគ", "ជំងឺរាគ",
      "គ្រុនចាញ់", "របេង",
      "ជំងឺបេះដូង", "សរសៃឈាមបេះដូង", "ដាច់សរសៃខួរ",
      "ទឹកនោមផ្អែម", "ជំងឺទឹកនោមផ្អែមប្រភេទ ២", "អាំងស៊ុយលីន",
      "មហារីក", "ដុំសាច់", "Alzheimer", "វង្វេងវង្វាន់",
      "ប្រទេសចំណូលទាប", "ប្រទេសចំណូលមធ្យម", "ប្រទេសចំណូលខ្ពស់", "សុខភាពសកល",
      "អនាម័យ", "ទឹកស្អាត", "វ៉ាក់សាំង",
      "ហេដ្ឋារចនាសម្ព័ន្ធ", "សុខុមាលភាព", "សុខភាពសាធារណៈ",
  ...
  {
    id: "chemistry-nitrogen-cycle",
    href: "/science/chemistry/nitrogen-cycle",
    icon: Leaf,
    titleEn: "The Nitrogen Cycle: Nature's Fertilizer Factory",
    titleKh: "វដ្តអាសូត៖ រោងចក្រជីធម្មជាតិ",
    categoryEn: "Chemistry · Biogeochemistry",
    categoryKh: "គីមីវិទ្យា · ជីវ-ភូមិ-គីមី",
    descEn:
      "78% of Earth's air is nitrogen (N₂), but the triple bond locks it away from plants. Follow the three-step natural loop — nitrogen fixation by lightning and root bacteria (N₂ → NH₃), nitrification into nitrites and nitrates (NO₂⁻ → NO₃⁻), and denitrification back to N₂ — and see how compost or Haber-Bosch fertilizer in a Cambodian rice paddy is just adding nitrates by hand.",
    descKh:
      "ខ្យល់ផែនដី ៧៨% គឺជាអាសូត (N₂) ប៉ុន្តែចំណងបីបិទវាមិនឱ្យរុក្ខជាតិចូល។ តាមដានរង្វិលធម្មជាតិបីជំហាន — ការកែច្នៃអាសូតដោយផ្គររន្ទះ និងបាក់តេរីឫស (N₂ → NH₃) នីទ្រីកម្មទៅជានីទ្រីត និងនីត្រាត (NO₂⁻ → NO₃⁻) និងឌីនីទ្រីកម្មត្រឡប់ទៅ N₂ — ហើយមើលរបៀបដែលជីកំប៉ុស្ត ឬជី Haber-Bosch នៅក្នុងស្រែស្រូវកម្ពុជា គ្រាន់តែដាក់នីត្រាតដោយដៃប៉ុណ្ណោះ។",
    keywordsEn: [
      "nitrogen cycle", "nitrogen", "n2", "n₂",
      "fixation", "nitrogen fixation",
      "nitrification", "denitrification",
      "nitrites", "nitrite", "no2", "no2-",
      "nitrates", "nitrate", "no3", "no3-",
      "ammonia", "nh3",
      "bacteria", "soil bacteria", "rhizobium", "nitrosomonas", "nitrobacter",
      "fertilizer", "fertiliser", "compost", "manure", "urea", "ammonium nitrate",
      "rice paddy", "rice", "agriculture", "farming", "cambodia",
      "lightning", "legumes", "root nodules",
      "biogeochemistry", "ecology",
    ],
    keywordsKh: [
      "វដ្តអាសូត", "អាសូត",
      "ការកែច្នៃអាសូត", "ការកែច្នៃ",
      "នីទ្រីកម្ម", "ឌីនីទ្រីកម្ម",
      "នីទ្រីត", "នីត្រាត", "អាម៉ូញាក់",
      "បាក់តេរី", "បាក់តេរីដី", "បាក់តេរីឫស",
      "ជី", "ជីកំប៉ុស្ត", "ជីសំយោគ", "ជីគីមី", "ជីសត្វ", "អ៊ុយរ៉េ",
      "ស្រែ", "ស្រូវ", "កសិកម្ម", "កម្ពុជា",
      "ផ្គររន្ទះ", "សណ្ដែក", "ពកឫស",
      "ជីវ-ភូមិ-គីមី", "បរិស្ថានវិទ្យា",
  ...
  // ── PUBLIC UNIVERSITIES (LAUNCHPAD GRID) ────────────────
  {
    id: "uni-rupp",
    href: "/launchpad/universities#uni-rupp",
    icon: GraduationCap,
    titleEn: "Royal University of Phnom Penh (RUPP)",
    titleKh: "សាកលវិទ្យាល័យភូមិន្ទភ្នំពេញ",
    categoryEn: "Universities", categoryKh: "សាកលវិទ្យាល័យ",
    descEn: "Cambodia's flagship public university — sciences, humanities, IT, and the Institute of Foreign Languages (IFL).",
    descKh: "សាកលវិទ្យាល័យសាធារណៈឈានមុខគេរបស់កម្ពុជា — វិទ្យាសាស្ត្រ មនុស្សសាស្ត្រ បច្ចេកវិទ្យាព័ត៌មាន និងវិទ្យាស្ថានភាសាបរទេស (IFL)។",
    keywordsEn: [
      "rupp", "royal university of phnom penh", "phnom penh university",
      "science", "humanities", "it", "information technology",
      "foreign languages", "ifl", "institute of foreign languages",
      "public university", "university", "higher education",
    ],
    keywordsKh: [
      "RUPP", "សាកលវិទ្យាល័យភូមិន្ទភ្នំពេញ",
      "វិទ្យាសាស្ត្រ", "មនុស្សសាស្ត្រ",
      "បច្ចេកវិទ្យាព័ត៌មាន", "ភាសាបរទេស", "IFL",
      "សាកលវិទ្យាល័យ", "ការសិក្សាខ្ពស់",
    ],
  },
  {
    id: "uni-itc",
    href: "/launchpad/universities#uni-itc",
    icon: GraduationCap,
    titleEn: "Institute of Technology of Cambodia (ITC)",
    titleKh: "វិទ្យាស្ថានបច្ចេកវិទ្យាកម្ពុជា",
    categoryEn: "Universities", categoryKh: "សាកលវិទ្យាល័យ",
    descEn: "Sala Techno — Cambodia's premier engineering school: civil, electrical, mechanical, chemical engineering, architecture, and computer science.",
    descKh: "សាលាតិចណូ — សាលាវិស្វកម្មលំដាប់កំពូលរបស់កម្ពុជា៖ វិស្វកម្មសំណង់ អគ្គិសនី មេកានិក គីមី ស្ថាបត្យកម្ម និងវិទ្យាសាស្ត្រកុំព្យូទ័រ។",
    keywordsEn: [
      "itc", "institute of technology of cambodia", "sala techno", "sala tekno",
      "engineering", "civil engineering", "electrical engineering", "mechanical engineering",
      "chemical engineering", "architecture", "computer science",
      "public university", "university", "higher education",
    ],
    keywordsKh: [
      "ITC", "វិទ្យាស្ថានបច្ចេកវិទ្យាកម្ពុជា", "សាលាតិចណូ",
      "វិស្វកម្ម", "ស្ថាបត្យកម្ម", "វិទ្យាសាស្ត្រកុំព្យូទ័រ",
      "សាកលវិទ្យាល័យ",
    ],
  },
  {
    id: "uni-rua",
    href: "/launchpad/universities#uni-rua",
    icon: GraduationCap,
    titleEn: "Royal University of Agriculture (RUA)",
    titleKh: "សាកលវិទ្យាល័យភូមិន្ទកសិកម្ម",
    categoryEn: "Universities", categoryKh: "សាកលវិទ្យាល័យ",
    descEn: "Cambodia's leading agricultural university — agronomy, veterinary medicine, food science, fisheries, and rural development.",
    descKh: "សាកលវិទ្យាល័យកសិកម្មឈានមុខគេរបស់កម្ពុជា — កសិកម្ម វេជ្ជសាស្ត្រសត្វ វិទ្យាសាស្ត្រអាហារ នេសាទ និងការអភិវឌ្ឍន៍ជនបទ។",
    keywordsEn: [
      "rua", "royal university of agriculture",
      "agronomy", "agriculture", "farming",
      "veterinary", "veterinary medicine", "vet",
      "food science", "fisheries", "rural development",
      "public university", "university",
    ],
    keywordsKh: [
      "RUA", "សាកលវិទ្យាល័យភូមិន្ទកសិកម្ម",
      "កសិកម្ម", "វេជ្ជសាស្ត្រសត្វ", "វិទ្យាសាស្ត្រអាហារ",
      "សាកលវិទ្យាល័យ",
    ],
  },
  {
    id: "uni-rule",
    href: "/launchpad/universities#uni-rule",
    icon: GraduationCap,
    titleEn: "Royal University of Law and Economics (RULE)",
    titleKh: "សាកលវិទ្យាល័យភូមិន្ទនីតិសាស្ត្រ និងវិទ្យាសាស្ត្រសេដ្ឋកិច្ច",
    categoryEn: "Universities", categoryKh: "សាកលវិទ្យាល័យ",
    descEn: "Cambodia's top public school of law and economics — law, public administration, finance, banking, and management.",
    descKh: "សាលាសាធារណៈឈានមុខគេរបស់កម្ពុជាខាងនីតិសាស្ត្រ និងសេដ្ឋកិច្ច — នីតិសាស្ត្រ រដ្ឋបាលសាធារណៈ ហិរញ្ញវត្ថុ ធនាគារ និងគ្រប់គ្រង។",
    keywordsEn: [
      "rule", "royal university of law and economics",
      "law", "law school", "legal", "lawyer", "attorney",
      "economics", "public administration", "administration",
      "finance", "banking", "management",
      "public university", "university",
    ],
    keywordsKh: [
      "RULE", "សាកលវិទ្យាល័យភូមិន្ទនីតិសាស្ត្រ និងវិទ្យាសាស្ត្រសេដ្ឋកិច្ច",
      "នីតិសាស្ត្រ", "ច្បាប់", "មេធាវី",
      "សេដ្ឋកិច្ច", "រដ្ឋបាលសាធារណៈ", "ហិរញ្ញវត្ថុ",
      "សាកលវិទ្យាល័យ",
    ],
  },
  {
    id: "uni-num",
    href: "/launchpad/universities#uni-num",
    icon: GraduationCap,
    titleEn: "National University of Management (NUM)",
    titleKh: "សាកលវិទ្យាល័យជាតិគ្រប់គ្រង",
    categoryEn: "Universities", categoryKh: "សាកលវិទ្យាល័យ",
    descEn: "Cambodia's national school of management and business — business administration, accounting, marketing, finance, and entrepreneurship.",
    descKh: "សាលាជាតិខាងគ្រប់គ្រង និងពាណិជ្ជកម្មរបស់កម្ពុជា — រដ្ឋបាលពាណិជ្ជកម្ម គណនេយ្យ ទីផ្សារ ហិរញ្ញវត្ថុ និងសហគ្រិនភាព។",
    keywordsEn: [
    ...
    keywordsKh: [
      ...
      "ពាណិជ្ជកម្ម", "គណនេយ្យ", "ទីផ្សារ",
      "ហិរញ្ញវត្ថុ", "សហគ្រិនភាព", "គ្រប់គ្រង",
      "សាកលវិទ្យាល័យ",
    ],
  },
  ...
  // ── WOMEN IN SCIENCE ────────────────────────────────────
  {
    ...
    icon: Users,
    titleEn: "Women in Science: The Pioneers",
    titleKh: "ស្ត្រីក្នុងវិស័យវិទ្យាសាស្ត្រ៖ អ្នកត្រួសត្រាយផ្លូវ",
    categoryEn: "Science", categoryKh: "វិទ្យាសាស្ត្រ",
    descEn: "Marie Curie, Rosalind Franklin, Tu Youyou, Ada Lovelace, Chien-Shiung Wu, Jane Goodall, Mary Anning, and dozens more — plus the everyday inventions women gave the world.",
    descKh: "ម៉ារី គុយរី រ៉ូហ្សាលីន ហ្វ្រែងឃ្លីន ទូ យូយូ អាដា ឡាវឡេស ជៀន-ស៊ូង វូ ជេន ហ្គូដាល់ ម៉ារី អានីង និងជាច្រើនទៀត — ព្រមទាំងការច្នៃប្រឌិតប្រចាំថ្ងៃដែលស្ត្រីបានផ្តល់ឱ្យពិភពលោក។",
    keywordsEn: [
      "women", "women in science", "female scientists", "pioneers",
      "marie curie", "rosalind franklin", "tu youyou", "katherine johnson",
      "christina koch", "katalin karikó", "katalin kariko", "katie bouman",
      "ada lovelace", "chien-shiung wu", "alice ball", "eugenie clark",
      "jane goodall", "mary anning",
      "nobel", "stem", "inspiration", "history", "directory",
    ],
    keywordsKh: [
      "ស្ត្រី", "ស្ត្រីក្នុងវិទ្យាសាស្ត្រ", "អ្នកត្រួសត្រាយផ្លូវ",
      "ម៉ារី គុយរី", "ហ្វ្រែងឃ្លីន", "ទូ យូយូ", "ខាធើរីន ចនសុន",
      "គ្រីស្ទីណា កុក", "ខេធី ប៊ូម៉ាន់",
      "អាដា ឡាវឡេស", "ជៀន ស៊ូង វូ", "អេលីស បល", "យូហ្ស៊ីនី ក្លាក",
      "ជេន ហ្គូដាល់", "ម៉ារី អានីង",
      "Nobel", "បំផុសគំនិត", "បញ្ជីឈ្មោះ",
    ],
  },
  {
    id: "women-in-science-trailblazers",
    href: "/science/women-in-science#trailblazers",
    icon: Sparkles,
    titleEn: "The Trailblazers",
    titleKh: "អ្នកត្រួសត្រាយផ្លូវ",
    categoryEn: "Women in Science", categoryKh: "ស្ត្រីក្នុងវិទ្យាសាស្ត្រ",
    descEn: "Profiles of thirteen scientists who faced doors closed to women — and opened them anyway.",
    descKh: "ប្រវត្តិអ្នកវិទ្យាសាស្ត្រស្ត្រី ១៣ រូបដែលបានជួបនឹងទ្វារដែលបិទចំពោះពួកគេ — ហើយបើកវាយ៉ាងរឹងមាំ។",
    keywordsEn: [
      "trailblazers", "pioneers", "role models", "scientists", "women in science",
      "marie curie", "rosalind franklin", "tu youyou", "katherine johnson",
      "christina koch", "katalin karikó", "katalin kariko", "katie bouman",
      "ada lovelace", "first programmer", "analytical engine",
      "chien-shiung wu", "first lady of physics", "wu experiment",
      "alice ball", "ball method", "leprosy",
      "eugenie clark", "shark lady", "ichthyology",
      "jane goodall", "chimpanzees", "primatology", "gombe",
      "mary anning", "fossils", "ichthyosaur", "plesiosaur", "paleontology",
    ],
    keywordsKh: [
      "អ្នកត្រួសត្រាយផ្លូវ", "តួគំរូ", "អ្នកវិទ្យាសាស្ត្រស្ត្រី",
      "ម៉ារី គុយរី", "ហ្វ្រែងឃ្លីន", "ទូ យូយូ",
      "អាដា ឡាវឡេស", "ជៀន ស៊ូង វូ", "អេលីស បល",
      "យូហ្ស៊ីនី ក្លាក", "ជេន ហ្គូដាល់", "ម៉ារី អានីង",
      "ស្វា", "ត្រី ឆ្លាម", "ផ្ទាំងថ្ម", "បុរាណវិទ្យាសាស្ត្រ",
    ],
  },
  {
    id: "women-in-science-directory",
    href: "/science/women-in-science#directory",
    icon: Users,
    titleEn: "Global Directory of Women Scientists",
    titleKh: "បញ្ជីឈ្មោះអ្នកវិទ្យាសាស្ត្រស្ត្រីទូទាំងពិភពលោក",
    categoryEn: "Women in Science", categoryKh: "ស្ត្រីក្នុងវិទ្យាសាស្ត្រ",
    descEn: "Searchable directory of 22 more pioneering women across Anthropology, Archaeology, Astronomy & Astrophysics, Biology & Genetics, Chemistry & Biochemistry, and Physics & Mathematics.",
    descKh: "បញ្ជីដែលអាចស្វែងរកបាន មានស្ត្រីត្រួសត្រាយផ្លូវចំនួន ២២ នាក់បន្ថែមទៀត លើផ្នែកនរវិទ្យា បុរាណវិទ្យា តារាសាស្ត្រ ជីវវិទ្យា គីមីវិទ្យា និងរូបវិទ្យា។",
    keywordsEn: [
      "directory", "list", "search", "women scientists", "female scientists",
      "anthropology", "archaeology", "astronomy", "astrophysics",
      "biology", "genetics", "chemistry", "biochemistry", "physics", "mathematics",
      // Anthropology
      "margaret mead", "mildred trotter", "dorothea leighton", "alicia dussán de reichel", "alicia dussan de reichel",
      // Archaeology
      "mary leakey", "proconsul", "dorothy garrod", "tatiana proskouriakoff", "maya hieroglyphs",
      "margaret rule", "mary rose",
      // Astronomy
      "vera rubin", "dark matter", "annie jump cannon", "stellar classification",
      "jocelyn bell burnell", "pulsars", "cecilia payne-gaposchkin", "cecilia payne",
      // Biology & Genetics
      "barbara mcclintock", "jumping genes", "transposons",
      "rachel carson", "silent spring", "june almeida", "coronavirus",
      "dian fossey", "mountain gorillas", "rwanda",
      // Chemistry & Biochemistry
      "stephanie kwolek", "kevlar", "gertrude elion", "gertrude b. elion",
      "leukemia", "gerty cori", "gerty theresa cori", "sugar metabolism",
      // Physics & Mathematics
      "maria goeppert-mayer", "maria goeppert mayer", "atomic nucleus",
      "shirley ann jackson", "telecommunications",
      "maryam mirzakhani", "fields medal",
    ],
    keywordsKh: [
      "បញ្ជីឈ្មោះ", "ស្វែងរក", "អ្នកវិទ្យាសាស្ត្រស្ត្រី",
      "នរវិទ្យា", "បុរាណវិទ្យា", "តារាសាស្ត្រ", "រូបវិទ្យាតារា",
      "ជីវវិទ្យា", "ហ្សែន", "គីមីវិទ្យា", "ជីវគីមីវិទ្យា", "រូបវិទ្យា", "គណិតវិទ្យា",
      "រ៉ាសែល ខាសុន", "ជេន ហ្វូស៊ី", "វែរ៉ា រូប៊ីន", "សារធាតុងងឹត",
      "ម៉ារីយ៉ាំ មៀហ្ស៊ាខានី", "មេដាយហ្វីលដ៍ស",
    ],
  },
  {
    id: "women-in-science-everyday-innovations",
    href: "/science/women-in-science#everyday-innovations",
    icon: Wrench,
    titleEn: "Everyday Innovations: Invented by Women",
    titleKh: "នវានុវត្តន៍ប្រចាំថ្ងៃ៖ បង្កើតឡើងដោយស្ត្រី",
    categoryEn: "Women in Science", categoryKh: "ស្ត្រីក្នុងវិទ្យាសាស្ត្រ",
    descEn: "Wi-Fi, the medical syringe, Kevlar, windshield wipers, the first computer compiler, Caller ID, laser cataract surgery, home security cameras, the dishwasher, and the circular saw — all invented by women.",
    descKh: "Wi-Fi សឺរ៉ាំងពេទ្យ Kevlar ប្រព័ន្ធជូតកញ្ចក់ កម្មវិធីបកប្រែកូដដំបូងគេ ការបង្ហាញលេខអ្នកហៅចូល ការវះកាត់ភ្នែកដោយឡាស៊ែរ កាមេរ៉ាសុវត្ថិភាពផ្ទះ ម៉ាស៊ីនលាងចាន និងរណាររង្វង់ — សុទ្ធតែបង្កើតដោយស្ត្រី។",
    keywordsEn: [
      "everyday innovations", "inventions", "inventors", "women inventors",
      "hedy lamarr", "wifi", "wi-fi", "bluetooth", "frequency hopping",
      "letitia geer", "syringe", "medical syringe",
      "stephanie kwolek", "kevlar", "bulletproof",
      "mary anderson", "windshield wiper", "windshield wipers",
      "grace hopper", "compiler", "first compiler",
      "shirley ann jackson", "caller id", "call waiting", "telecommunications",
      "patricia bath", "laser", "laser cataract", "laserphaco", "cataract surgery",
      "marie van brittan brown", "cctv", "home security", "video doorbell", "security camera",
      "josephine cochrane", "dishwasher",
      "tabitha babbitt", "circular saw", "saw",
    ],
    keywordsKh: [
      "នវានុវត្តន៍ប្រចាំថ្ងៃ", "ការបង្កើត", "អ្នកបង្កើតស្ត្រី",
      "Wi-Fi", "Bluetooth", "សឺរ៉ាំងពេទ្យ", "Kevlar", "ប្រព័ន្ធជូតកញ្ចក់",
      "compiler", "ការបង្ហាញលេខអ្នកហៅចូល", "ការវះកាត់ភ្នែកដោយឡាស៊ែរ",
      "កាមេរ៉ាសុវត្ថិភាពផ្ទះ", "CCTV", "ម៉ាស៊ីនលាងចាន", "រណាររង្វង់",
    ],
  },
  {
    id: "automotive-hypercar-hall-of-fame",
    href: "/technology/automotive#hypercar-hall",
    icon: Car,
    titleEn: "Hypercar Hall of Fame",
    titleKh: "សាលកិត្តិយសរថយន្តល្បឿនលឿន",
    categoryEn: "Showroom", categoryKh: "បន្ទប់តាំងពិព័រណ៍",
    descEn: "Bugatti Chiron, Lamborghini Aventador, Ferrari SF90 Stradale, Porsche 911 Turbo S, Chevrolet Corvette Z06, Aston Martin Valkyrie — the world's most extreme road cars, side by side.",
    descKh: "Bugatti Chiron, Lamborghini Aventador, Ferrari SF90 Stradale, Porsche 911 Turbo S, Chevrolet Corvette Z06, Aston Martin Valkyrie — រថយន្តដ៏អស្ចារ្យបំផុតលើពិភពលោក តាំងបង្ហាញចំហៀងគ្នា។",
    keywordsEn: [
      "hypercar", "hypercars", "supercar", "supercars", "hall of fame", "showroom",
      "bugatti", "chiron", "lamborghini", "aventador",
      "ferrari", "sf90", "stradale", "porsche", "911 turbo",
      "chevrolet", "corvette", "z06", "aston martin", "valkyrie",
      "v12", "horsepower", "top speed", "performance car", "exotic car",
    ],
    keywordsKh: [
      "សាលកិត្តិយស", "បន្ទប់តាំងពិព័រណ៍", "រថយន្តល្បឿនលឿន",
      "Bugatti", "Chiron", "Lamborghini", "Aventador",
      "Ferrari", "Porsche", "Corvette", "Aston Martin", "Valkyrie",
      "ល្បឿនអតិបរមា", "កម្លាំងសេះ",
    ],
  },
